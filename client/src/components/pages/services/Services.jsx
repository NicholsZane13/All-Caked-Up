    ...
    <body>
        ...
        <div className="bg-green justify-center text-center pt-20 pb-10">
            ...
            <div className="grid grid-rows-1 grid-flow-col gap-4">
                ...
                <img className="items-center object-contain h-48 w-60 rounded-t-lg" src={cakeArt} alt="edible image" />
                    <div className="p-1">
                        <h5 className="mb-2 text-2xl font-bold text-center tracking-tight text-tan">Wedding Cakes</h5>
                    </div>
                </div>
                <div className="row-start1 row-end-3 max-w-fit p-2 bg-green border-2 rounded-lg shadow">
                <img className="items-center object-contain h-48 w-60 rounded-t-lg" src={cake} alt="edible image" />
                    <div className="p-1">
                        <h5 className="mb-2 text-2xl font-bold text-center tracking-tight text-tan ">Custom Cakes</h5>
                    </div>
                </div>
                <div className="row-start1 row-end-3 max-w-fit p-2 bg-green border-2 rounded-lg shadow">
                <img className="items-center object-contain h-48 w-60 rounded-t-lg" src={cookie} alt="edible image" />
                    <div className="p-1">
                        <h5 className="mb-2 text-2xl font-bold text-center tracking-tight text-tan ">Custom Cookies</h5>
                    </div>
                </div>
                <div className="row-start1 row-end-3 max-w-fit p-2 bg-green border-2 rounded-lg shadow">
                <img className="items-center object-contain h-48 w-60 rounded-t-lg" src={cupcake} alt="edible image" />
                <div className="p-1">
                    <h5 className="mb-2 text-2xl font-bold text-center tracking-tight text-tan ">Custom Cupcakes</h5>
                </div>
                </div>
                <div className="row-start1 row-end-3 max-w-fit p-2 bg-green border-2 rounded-lg shadow">
                <img className="items-center object-contain h-48 w-60 rounded-t-lg" src={pastries} alt="edible image" />
                    <div className="p-1">
