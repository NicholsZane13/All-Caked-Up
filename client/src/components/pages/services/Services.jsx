...
<div className="justify-center flex">
    <ul className="mb-8 space-y-4">
        <li className="space-x-3">
            {cakeIcon}
            <span  className="">Browse through our site and gather some inspiration!</span>
        </li>
        <li className="space-x-3">    
            {cakeIcon}
            <span className="">Find the details about your order. How many are you feeding?</span>
        </li>
        <li className="space-x-3">
            {cakeIcon}
        ...
        <li className="space-x-3">
            {cakeIcon}
            <span className="">Premium support:</span>
        </li>
        <li className="space-x-3">
            {cakeIcon}
            <span className="">Free updates</span>
        </li>
    </ul>
</div>
        <Contact />
