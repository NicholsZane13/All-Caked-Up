      ...
      <>
        ...
        <div className="bg-green sm:grid-cols-1 flex pl-10 pt-20 pb-10">
            <div className="content-left">
              <h1 className="font-Gloock text-left text-tan text-4xl md:text-7xl mb-1 md:mb-3 font-bold">Origin Story : All Caked Up</h1>
            </div>
            <div className="">
              <img className="border rounded-full h-auto max-w-lg mx-auto" src={MainPic} alt="cute pic" />
            </div>
            <div>
              <p className="font-Indie text-tan text-lg max-w-xl m-6 font-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,
